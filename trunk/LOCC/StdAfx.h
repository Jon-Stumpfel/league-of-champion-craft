...
using std::string;
	...
	enum SPELL_TYPE { SP_BLANK, SP_FIREBALL, SP_CHARGE, SP_TEST, SP_SPAWNARCHER, SP_SPAWNSWORD, SP_SPAWNCALV, SP_HEAL,
		...
		SP_ICEAGE, SP_FIRENOVA, SP_SKILLSHOT,SP_LIGHTCHAIN, SP_WHIRLWIND,SP_PSHOT, SP_CLEAVE, SP_BLADESTORM, SP_SWORDDANCE,SP_RUSH, SP_KILL, SP_FORT, SP_DEATH, SP_MIND, SP_NUMSPELLS};
