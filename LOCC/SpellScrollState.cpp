...
void CSpellScrollState::Render(void)
{
	...
	if( flipping == false && unflipping == false )
	{
		if( m_bTreeSelect == false )
		{
			...
			/////////////////////////////////////////////////////////////////
			// BUG FIX
			// Reference Bug # BB-038
			// BUG FIX START
			/////////////////////////////////////////////////////////////////
			int x,y;
			if( selected->GetType() != SP_RUSH && selected->GetType() != SP_PSHOT )
				x = 680 - 65, y = 525;
			else
				x = 680 - 65, y = 500;
			/////////////////////////////////////////////////////////////////
