		...
		else if (ability->m_nNumTargets == 1)
		{
			...
			else if (m_bIsTargeting == true && m_pTargetedTile != nullptr)
			{
				...
				else
				{
					...
					// BUG FIX START
					/////////////////////////////////////////////////////////////////
					if( m_pTargetedTile->GetTileType() == TT_WATER && ability->GetType() == SP_RAISEDEAD && m_pTargetedTile->GetIfFrozen() == false )
						return;
					/////////////////////////////////////////////////////////////////
	...
	if( m_pSelectedUnit != nullptr )
	{
		...
		{	
			...
			if( pHero != nullptr )
			{
				...
				if (pA != nullptr)
				{
					...
					/////////////////////////////////////////////////////////////////
					// BUG FIX
					// Reference Bug # BB-049
					// BUG FIX START
					/////////////////////////////////////////////////////////////////
					/////////////////////////////////////////////////////////////////
					// BUG FIX
					// Reference Bug # BB-050
					// BUG FIX START
					/////////////////////////////////////////////////////////////////
					/////////////////////////////////////////////////////////////////
					// BUG FIX
					// Reference Bug # BB-051
					// BUG FIX START
					/////////////////////////////////////////////////////////////////
					...
					/////////////////////////////////////////////////////////////////
					// BUG FIX
					// Reference Bug # BB-053
					// BUG FIX START
					/////////////////////////////////////////////////////////////////
					/////////////////////////////////////////////////////////////////
					// BUG FIX
					// Reference Bug # BB-054
					// BUG FIX START
					/////////////////////////////////////////////////////////////////
					/////////////////////////////////////////////////////////////////
					// BUG FIX
					...
					// BUG FIX START
					/////////////////////////////////////////////////////////////////
					m_pBitmapFont->Print(pA->GetDescription().c_str(), 438, m_nTooltipOffsetY + 12, 0.17f, D3DCOLOR_XRGB(255,255,255), 105);
					/////////////////////////////////////////////////////////////////
					// BUG FIX END  Reference # BB-061
					/////////////////////////////////////////////////////////////////
					/////////////////////////////////////////////////////////////////
					...
					/////////////////////////////////////////////////////////////////
					/////////////////////////////////////////////////////////////////
					// BUG FIX END  Reference # BB-049
					/////////////////////////////////////////////////////////////////
					/////////////////////////////////////////////////////////////////
					// BUG FIX END  Reference # BB-050
					/////////////////////////////////////////////////////////////////
					/////////////////////////////////////////////////////////////////
					// BUG FIX END  Reference # BB-051
					/////////////////////////////////////////////////////////////////
					/////////////////////////////////////////////////////////////////
					// BUG FIX END  Reference # BB-052
					/////////////////////////////////////////////////////////////////
					////////////////////////////////////////////////////////////////
					// BUG FIX END  Reference # BB-053
					/////////////////////////////////////////////////////////////////
					/////////////////////////////////////////////////////////////////
					// BUG FIX END  Reference # BB-054
					/////////////////////////////////////////////////////////////////
					/////////////////////////////////////////////////////////////////
		...
		else if( m_bSelectChampionAbility == false )
		{
			...
			if (pA != nullptr)
			{
				...
				/////////////////////////////////////////////////////////////////
				// BUG FIX
				// Reference Bug # BB-047
				// BUG FIX START
				/////////////////////////////////////////////////////////////////
				m_pBitmapFont->Print(pA->GetDescription().c_str(), 438, m_nTooltipOffsetY + 12, 0.175f, D3DCOLOR_XRGB(255,255,255), 105);
				/////////////////////////////////////////////////////////////////
				// BUG FIX END  Reference # BB-047
				/////////////////////////////////////////////////////////////////
			}
		}
	}
