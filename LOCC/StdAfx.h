...
using std::string;
	...
	enum SPELL_TYPE { SP_BLANK, SP_FIREBALL, SP_CHARGE, SP_TEST, SP_SPAWNARCHER, SP_SPAWNSWORD, SP_SPAWNCALV, SP_HEAL,
		...
		SP_ICEAGE, SP_FIRENOVA, SP_SKILLSHOT,SP_LIGHTCHAIN, SP_WHIRLWIND,SP_PSHOT, SP_CLEAVE, SP_BLADESTORM, SP_SWORDDANCE,SP_RUSH, SP_KILL, SP_FORT, SP_DEATH, SP_NUMSPELLS};
	...
	enum PRTCL_TYPE { TEST, TESTSECOND, PT_FIRE, PT_CARTOGRAPHY, PT_DESTROYFOREST, PT_HEALCROSS,PT_EXPLODE, PT_WHIRLWIND,
		PT_RALLY, PT_PATHFINDER, PT_RAISEMOUNTAIN, PT_BLOOD, PT_STAND, PT_RAISEDEAD, PT_OBLOOD, PT_ICEBOLT, PT_MAGIC, PT_LIGHTBOLT, PT_FIREWEP, PT_FORT, PT_DEATH };
