...
//#define ARCADE_BUILD
	...
	enum PRTCL_TYPE { TEST, TESTSECOND, PT_FIRE, PT_CARTOGRAPHY, PT_DESTROYFOREST, PT_HEALCROSS,PT_EXPLODE, PT_WHIRLWIND,
		PT_RALLY, PT_PATHFINDER, PT_RAISEMOUNTAIN, PT_BLOOD, PT_STAND, PT_RAISEDEAD, PT_OBLOOD, PT_ICEBOLT, PT_MAGIC, PT_LIGHTBOLT, PT_FIREWEP, PT_FORT, PT_DEATH, PT_MIND, PT_MOVE };
