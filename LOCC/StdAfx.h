...
using std::string;
	...
	enum SPELL_TYPE { SP_FIREBALL, SP_CHARGE, SP_TEST, SP_SPAWNARCHER, SP_SPAWNSWORD, SP_SPAWNCALV, SP_HEAL,
		...
		SP_RAISEDEAD, SP_ICEBOLT, SP_MAGIC, SP_LIGHTBOLT, SP_FIREWEP, SP_ICEBLOCK, SP_LIGHTSTRIKE,SP_EXPSHOT,SP_HEAVYBLOW, SP_ICEAGE, SP_FIRENOVA, SP_SKILLSHOT, SP_NUMSPELLS};

	enum SCRIPT_TYPE { ST_LEVEL };

	enum PRTCL_TYPE { TEST, TESTSECOND, PT_FIRE, PT_CARTOGRAPHY, PT_DESTROYFOREST, PT_HEALCROSS,PT_EXPLODE, 
