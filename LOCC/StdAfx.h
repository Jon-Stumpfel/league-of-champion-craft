...
//#define ARCADE_BUILD
	...
	enum TILE_STATUS	{ TS_FROZEN, TS_RESOURCETILE, TS_OCCUPIED, TS_CAPTURING, TS_CAPTURED, TS_IS_DEAD, TS_ISIMPASSABLE };
	...
	enum SPELL_TYPE { SP_BLANK, SP_FIREBALL, SP_CHARGE, SP_TEST, SP_SPAWNARCHER, SP_SPAWNSWORD, SP_SPAWNCALV, SP_HEAL,
		...
		SP_ICEAGE, SP_FIRENOVA, SP_SKILLSHOT,SP_LIGHTCHAIN, SP_WHIRLWIND,SP_PSHOT, SP_CLEAVE, SP_BLADESTORM, SP_SWORDDANCE,
		SP_RUSH, SP_KILL, SP_FORT, SP_DEATH, SP_MIND, SP_TELE, SP_SAC, SP_MASSRAISE, SP_VAMP, SP_TORN, SP_DESTROY, SP_ENCASE, SP_NUMSPELLS, SP_FAKEMAPMOD};
	...
	enum PRTCL_TYPE { TEST, TESTSECOND, PT_FIRE, PT_CARTOGRAPHY, PT_DESTROYFOREST, PT_HEALCROSS,PT_EXPLODE, PT_WHIRLWIND,
		PT_RALLY, PT_PATHFINDER, PT_RAISEMOUNTAIN, PT_BLOOD, PT_STAND, PT_RAISEDEAD, PT_OBLOOD, PT_ICEBOLT, PT_MAGIC, PT_LIGHTBOLT,
		PT_FIREWEP, PT_FORT, PT_DEATH, PT_MIND, PT_MOVE, PT_SHIELD, PT_SPEED, PT_SPAWN };

	enum GAME_PHASE { GP_MOVE, GP_ATTACK };

	enum CAPFLAG {F_RED_CAPTURED,F_BLUE_CAPTURED,F_RED_CAPTURING,F_BLUE_CAPTURING};
	// resource amounts
	const int POP_PER_FARM = 4;
