...
using std::string;
	...
	enum TILE_TYPE		{ TT_PLAINS, TT_FOREST, TT_MOUNTAINS, TT_WATER, TT_FARM, TT_MILL, TT_MINE, TT_TOMBSTONE };
	...
	enum SPELL_TYPE { SP_FIREBALL, SP_CHARGE, SP_TEST, SP_SPAWNARCHER, SP_SPAWNSWORD, SP_SPAWNCALV, SP_HEAL,
		...
		SP_CARTOGRAPHY, SP_DESTROYFOREST, SP_HEALBURST, SP_RALLY, SP_PATHFINDER, SP_RAISEMOUNTAIN, SP_NUMSPELLS};

	enum SCRIPT_TYPE { ST_LEVEL };

	enum PRTCL_TYPE { TEST, TESTSECOND, PT_FIRE, PT_CARTOGRAPHY, PT_DESTROYFOREST, PT_HEALCROSS, 
		PT_RALLY, PT_PATHFINDER, PT_RAISEMOUNTAIN };
