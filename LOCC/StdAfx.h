...
using std::string;
	...
	enum SPELL_TYPE { SP_FIREBALL, SP_CHARGE, SP_TEST, SP_SPAWNARCHER, SP_SPAWNSWORD, SP_SPAWNCALV, SP_HEAL, SP_SHIELD, SP_SPEED, SP_MELEEATTACK, SP_ARCHERRANGEDATTACK, SP_MOVE, SP_CHAMPSPELL, SP_NUMSPELLS};
